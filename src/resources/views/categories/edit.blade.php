        ...
        <div class="ibox">
            ...
            <div class="ibox-content">
                ...
                <div class="mb-3">
                    ...
                    {!! Form::text('name', $category->name , array('placeholder' => 'Name','id'=>'name','class' => 'form-control')) !!}
                    @if ($errors->has('name'))
                ...
                <div class="mb-3">
                    ...
                    {!! Form::text('slug', $category->slug, array('placeholder' => 'Slug','id'=>'slug','class' => 'form-control')) !!}
                    @if ($errors->has('slug'))
                ...
                <div class="mb-3">
                    ...
                    Active @if($category->status ==1 ) {{ Form::radio('status',1 ,true ,array()) }}
                    @else {{ Form::radio('status',1 ,array()) }}
                    @endif
                    Block  @if($category->status == 0 ) {{ Form::radio('status',0 ,true ,array()) }}
